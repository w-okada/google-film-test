...
module.exports = {
    ...
    plugins: [
        ...
        // new CopyPlugin({
        //     patterns: [{ from: "models/film_net_L1_180x320/tfjs_model_float32", to: "models/film_net_L1_180x320/tfjs_model_float32" }],
        // }),

        new CopyPlugin({
            patterns: [{ from: "models/tfjs/L1", to: "models/tfjs/L1" }],
        }),
